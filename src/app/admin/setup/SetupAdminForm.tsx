...
export function SetupAdminForm({ hasExistingAdmin }: SetupAdminFormProps) {
  ...
  async function setupAdmin() {
    ...
    if (adminPassword.length < 6) {
      setResult({ success: false, message: '密码长度至少6位' })
      return
    }
